package com.joongbu.mybatis_board.controller;
...
import com.joongbu.mybatis_board.mapper.UserMapper;
...
public class UserController {
	...
	public String list(
		...
		return "/user/list";  //req.getRequestDispatcher("WEB-INF/template/user/list.html").forward(req,resp);
	}
	@GetMapping("/list2.do")
	public String list2(
			Model model,
...
//	}
	...
	public String delete(String userId) {
		...
		if(delete>0) {
			...
			return "redirect:/user/delete.do?userId="+userId;
		}
	}
